...
class Button : public Button {
 public:
    ...
    ButtonIndicator(int const kPinInput, enum Button::ButtonIndicatorTypes const kButtonType, const Accessory* const output);
    ButtonIndicator(int const kPinInput, enum Button::ButtonIndicatorTypes const kButtonType, const Engine* const engine);
