...
Indicator::Indicator(unsigned int const kPinOutput, unsigned int const kFlashRate, Motorcycle &motorcycle) : Accessory(kPinOutput), motorcycle_(motorcycle), kFlashCycle_(MILLISECONDS_PER_MINUTE / (kFlashRate * 2))
{
}
